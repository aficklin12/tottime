...
urlpatterns = [
    ...
    path('index_cacfp.html', login_required(views.index_cacfp), name='index_cacfp'),  
    ...
    path('edit_item_name/<int:item_id>/', login_required(views.edit_item_name), name='edit_item_name'),
    path('edit_inventory_item/<int:item_id>/', login_required(views.edit_inventory_item), name='edit_inventory_item'),
    ...
    path('api/fetch_inventory_rules/', login_required(views.fetch_inventory_rules), name='fetch_inventory_rules'),
    path('account_settings/', login_required(views.account_settings), name='account_settings'),
    path('account_settings/subscription/auto-renew/', login_required(views.create_square_auto_renew_subscription), name='create_square_auto_renew_subscription'),
    path('account_settings/subscription/start/', login_required(views.start_square_subscription_checkout), name='start_square_subscription_checkout'),
    path('account_settings/subscription/cancel/', login_required(views.cancel_square_subscription_at_period_end), name='cancel_square_subscription_at_period_end'),
    path('account_settings/subscription/callback/', login_required(views.square_subscription_callback), name='square_subscription_callback'),
    path('webhooks/square/subscription/', views.square_subscription_webhook, name='square_subscription_webhook'),
